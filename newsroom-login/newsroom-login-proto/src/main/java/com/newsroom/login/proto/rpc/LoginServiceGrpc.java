...
/**
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.4.0)", comments = "Source: login.proto")
public final class LoginServiceGrpc {

    private LoginServiceGrpc() {
    }

    public static final String SERVICE_NAME = "com.newsroom.login.proto.rpc.LoginService";

    // Static method descriptors that strictly reflect the proto.
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
    public static final io.grpc.MethodDescriptor<com.newsroom.login.proto.rpc.LoginRequest, com.newsroom.login.proto.rpc.LoginResponse> METHOD_LOGIN = io.grpc.MethodDescriptor.<com.newsroom.login.proto.rpc.LoginRequest, com.newsroom.login.proto.rpc.LoginResponse> newBuilder()
            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
            .setFullMethodName(generateFullMethodName("com.newsroom.login.proto.rpc.LoginService", "login"))
            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
                    .marshaller(com.newsroom.login.proto.rpc.LoginRequest.getDefaultInstance()))
            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
                    .marshaller(com.newsroom.login.proto.rpc.LoginResponse.getDefaultInstance()))
            .build();
    ...
    public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
        ...
        /**
         */
        public void login(com.newsroom.login.proto.rpc.LoginRequest request,
                io.grpc.stub.StreamObserver<com.newsroom.login.proto.rpc.LoginResponse> responseObserver) {
        ...
        public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(METHOD_LOGIN, asyncUnaryCall(
                            new MethodHandlers<com.newsroom.login.proto.rpc.LoginRequest, com.newsroom.login.proto.rpc.LoginResponse>(
                                    this, METHODID_LOGIN)))
                    .build();
        }
    }
    ...
    public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractStub<LoginServiceBlockingStub> {
        ...
        @java.lang.Override
        protected LoginServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new LoginServiceBlockingStub(channel, callOptions);
        }

        /**
         */
        public com.newsroom.login.proto.rpc.LoginResponse login(com.newsroom.login.proto.rpc.LoginRequest request) {
    ...
    public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractStub<LoginServiceFutureStub> {
        ...
        @java.lang.Override
        protected LoginServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new LoginServiceFutureStub(channel, callOptions);
        }

        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<com.newsroom.login.proto.rpc.LoginResponse> login(
                com.newsroom.login.proto.rpc.LoginRequest request) {
    ...
    private static final class MethodHandlers<Req, Resp> implements io.grpc.stub.ServerCalls.UnaryMethod<Req, Resp>,
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
            case METHODID_LOGIN:
                serviceImpl.login((com.newsroom.login.proto.rpc.LoginRequest) request,
                        (io.grpc.stub.StreamObserver<com.newsroom.login.proto.rpc.LoginResponse>) responseObserver);
                break;
            default:
    ...
    private static final class LoginServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.newsroom.login.proto.rpc.Login.getDescriptor();
        }
    }
            ...
            synchronized (LoginServiceGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                            .setSchemaDescriptor(new LoginServiceDescriptorSupplier()).addMethod(METHOD_LOGIN).build();
                }
            }
        }
        return result;
